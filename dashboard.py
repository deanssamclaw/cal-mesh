...
#
# To promote the next version: build PAGE_V5, move PAGE_V4 into RETIRED_PAGES as "old-4",
# point CURRENT_PAGE at PAGE_V5, and drop the stale entry from LEGACY_ALIASES.
CURRENT_PAGE = PAGE_V4
RETIRED_PAGES = {
