...
Run:  python3 evals/eval_trace_dark.py     (exit 0 = pass; skips cleanly if node is unavailable)
"""
import json
import os
import re
...
# --------------------------------------------------------------------------------------
_ER = open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "eval_render.py")).read()
