...
Run:  python3 evals/eval_render.py        (exit 0 = pass; skips cleanly if node is unavailable)
      python3 evals/eval_render.py --self-test   also proves the checks can FAIL (negative controls)
"""
import json
import os
import re
