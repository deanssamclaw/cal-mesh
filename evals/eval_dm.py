...
Run: python3 evals/eval_dm.py [-v]
"""
...
# Load the dashboard IN THIS CHECKOUT (the repo root above evals/), by explicit path. A plain `import dashboard`
...
check("testing the dashboard in this checkout", os.path.dirname(os.path.abspath(D.__file__)),
      HERE)
