...
Run:  python3 evals/eval_exchanges.py                (exit 0 = pass)
      python3 evals/eval_exchanges.py --self-test    also proves the checks can FAIL
"""
...
if "--self-test" in sys.argv:
    ...
    for name, edits in MUTANTS.items():
        ...
        shutil.copy(os.path.abspath(__file__), os.path.join(mdir, "eval_exchanges.py"))
